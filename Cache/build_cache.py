...
parser = make_parser("Build Sentinel index cache")
add_aoi_arg(parser)
...
for index_name in INDICES_TO_RUN:
    manifest_path = CACHE_BASE_DIR / index_name / "cache_manifest.json"
...
for scene_idx, item in enumerate(items):
    ...
    for index_name in INDICES_TO_RUN:
        ...
        output_path = CACHE_BASE_DIR / index_name / output_filename
    ...
    print(
        f"  Date: {item.datetime}  |  Tile: {tile_id}  |  "
