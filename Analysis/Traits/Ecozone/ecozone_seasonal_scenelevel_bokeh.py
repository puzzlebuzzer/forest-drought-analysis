...
Run from the Python directory:
  python Analysis/Traits/Ecozone/ecozone_seasonal_scenelevel_bokeh.py
  python Analysis/Traits/Ecozone/ecozone_seasonal_scenelevel_bokeh.py --indices NDVI NDMI
  python Analysis/Traits/Ecozone/ecozone_seasonal_scenelevel_bokeh.py --points-only
"""
