...
Run from the Python directory:
  python Analysis/SupportingAnalyses/EcozoneInvestigations/ecozone_seasonal_scenelevel_plotly.py
  python Analysis/SupportingAnalyses/EcozoneInvestigations/ecozone_seasonal_scenelevel_plotly.py --indices NDVI NDMI
  python Analysis/SupportingAnalyses/EcozoneInvestigations/ecozone_seasonal_scenelevel_plotly.py --no-band
"""
