...
ECOZONE_HELPER_DIR = PROJECT_ROOT / "Analysis" / "SupportingAnalyses" / "EcozoneInvestigations"
...
`Python/Analysis/SupportingAnalyses/Diagnostics/anomaly_from_normal_demo.py`
